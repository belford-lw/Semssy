...
const About = () => {
  return (
    <div className="bg-[#0b0b18] text-white py-20 px-6">
      
      <h2 className="text-4xl font-semibold text-center ">
        We’re a creative agency dedicated to <br />
        helping brands grow through <span className="font-serif ">
          passion, strategy, <br /> design, and innovation.
        </span>
      </h2>

      <div className="max-w-6xl mx-auto grid  grid-cols-3 gap-6 items-center">

        <div className="border border-neutral-500 p-10 text-center">
          <h3 className="text-3xl font-bold">05+</h3>
          <p className="text-neutral-500 ">Years of Experience</p>
          
        </div>

        <div className="row-span-2 border border-neutral-500 overflow-hidden " >
          <img
